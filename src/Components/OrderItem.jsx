    ...
    <div className=' flex items-center'>
      <div className='w-full flex p-2 gap-2 items-center justify-between'>
        ...
        <div className='flex h-full flex-col items-center justify-between gap-3'>
          ...
          <div className='flex gap-4 rounded-xl text-sm font-semibold items-center px-3 py-1.5 bg-gray-100 w-fit'>
            {' '}
            Quantity: {quantity}{' '}
          </div>
          {status === 'Ordered' && (
            <button className='w-full  border border-red-500 text-red-500 text-sm hover:bg-red-500 hover:text-white py-1.5 px-4 rounded-full transition duration-300 ease-in-out focus:outline-none'>
              Cancel
            </button>
          )}
        </div>
