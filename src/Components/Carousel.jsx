...
const PrevArrow = (props) => {
  ...
  return (
    <div
      className='md-mx:hidden absolute z-10 cursor-pointer   slick-arrow top-[40%] left-5'
      onClick={onClick}
    >
...
const NextArrow = (props) => {
  ...
  return (
    <button
      className='md-mx:hidden absolute z-10 slick-arrow top-[40%] right-5'
      onClick={onClick}
    >
        ...
        {offers.map((x, index) => (
          ...
          >
            <img
              ...
              alt='Slide'
              className='w-auto object-cover min-h-[25vh] '
            />
          </div>
        ))}
      </Slider>
